...
public class MainActivity extends AppCompatActivity {
    ...
    Button btnShowEncrypted,btnShowDecrypted;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnShowEncrypted=(Button) findViewById(R.id.btnShowEncrypted);
        btnShowDecrypted=(Button) findViewById(R.id.btnShowDecrypted);
        ...
        ActivityCompat.requestPermissions(MainActivity.this,
                ...
                1);
        btnShowEncrypted.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                //Toast.makeText(getApplicationContext(),"Clicked",Toast.LENGTH_SHORT).show();
                Intent intent=new Intent(getApplicationContext(),com.example.imageed.Main2Activity.class);
                intent.putExtra("ip",ipv4AddressView.getText().toString());
                startActivity(intent);
            }
        });
        btnShowDecrypted.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent=new Intent(getApplicationContext(),com.example.imageed.Main3Activity.class);
                intent.putExtra("ip",ipv4AddressView.getText().toString());
                startActivity(intent);
            }
        });
            ...
            public void onFailure(Call call, IOException e) {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        responseText.setText("Encyption done! ");
